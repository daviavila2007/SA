  ...
  return (
    <div className="product-page">
      <header className="header">
        <div className="logo">
          <img src="./src/logo.png" alt="Lost Plushy Logo" />
        </div>
        <div className="icons">
      ...
      <div className="product-list">
        ...
        <div className="product-card">
          <img src="./src/Golden.png" alt="Pelúcia Golden Freddy" />
          <div className="product-info">
        ...
        <div className="product-card">
          <img src="./src/Foxy.png" alt="Pelúcia Foxy" />
          <div className="product-info">
            <h3>Pelúcia Foxy</h3>
            <p>R$ 49,90</p>
          </div>
        ...
        <div className="product-card">
          <img src="./src/Shadow.png" alt="Pelúcia Shadow Freddy" />
          <div className="product-info">
